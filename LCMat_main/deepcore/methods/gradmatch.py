...
class GradMatch(EarlyTrain):
    ...
    def orthogonal_matching_pursuit_curv(self, A, b, budget: int, lam: float = 1.):
        '''approximately solves min_x |x|_0 s.t. Ax=b using Orthogonal Matching Pursuit
        Acknowlegement to:
        https://github.com/krishnatejakk/GradMatch/blob/main/GradMatch/selectionstrategies/helpers/omp_solvers.py
        Args:
    ...
    def calc_gradient(self, index=None, val=False):
        ...
        for i, (input, targets) in enumerate(batch_loader):
            ...
            with torch.no_grad():
                ...
                # print(bias_parameters_grads.shape)
                ...
                # print(torch.cat([bias_parameters_grads, weight_parameters_grads.flatten(1)], dim=1).shape)
    ...
    def select(self, **kwargs):
        ...
        if self.args.after_analyses:
            ...
            for c in range(self.num_classes):
                ...
                analyses_dict['global_hess_exact_max_eigen' + str(c)] = eigen_dict[int(c + 1)]
